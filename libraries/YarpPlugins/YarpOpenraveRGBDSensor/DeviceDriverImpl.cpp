...
bool YarpOpenraveRGBDSensor::open(yarp::os::Searchable& config)
{
    ...
    int depthSensorIndex = config.check("depthSensorIndex",NOT_SET,"depth sensor index").asInt();
    int rgbSensorIndex = config.check("rgbSensorIndex",NOT_SET,"RGB sensor index").asInt();
